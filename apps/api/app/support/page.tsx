...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '체키 지원',
    description: '그룹 일정과 주차 위치를 관리하는 체키의 도움말과 문의 안내입니다.',
    siteName: '체키',
    type: 'website',
    locale: 'ko_KR',
  },
...
const faqs = [
  {
    title: '그룹을 먼저 만들어야 하나요?',
    description:
      '네. 체키는 그룹 단위로 일정과 주차 정보를 관리합니다. 로그인 후 그룹을 만들고 구성원을 등록하면 일정, 반복 일정, 주차 기능을 사용할 수 있습니다.',
  },
  {
  ...
  {
    title: '주차 위치는 그룹 내 구성원끼리 공유되나요?',
    description:
      '같은 그룹에 등록된 구성원은 차량별 주차 위치를 확인할 수 있습니다. 대표 권한을 가진 구성원은 차량과 즐겨찾는 위치를 관리할 수 있습니다.',
  },
  {
    title: '계정을 삭제할 수 있나요?',
    description:
    ...
    <main className="support-shell">
      <section className="support-hero">
        ...
        <p className="description">
          체키는 그룹 일정, 반복 일정, 차량 주차 위치를 한곳에서
          관리할 수 있도록 돕는 그룹 관리 앱입니다. 사용 중 문제가 있거나
      ...
      <section className="support-section" aria-labelledby="support-privacy-title">
        ...
        <div className="support-list">
          ...
          <article className="support-item">
            <h3>연락처</h3>
            <p>
              반복 일정 전화번호 입력 시 기기의 연락처에서 번호를 선택할 수
              있습니다. 선택한 전화번호만 반복 일정 정보에 저장됩니다.
            </p>
          </article>
          <article className="support-item">
            <h3>계정 삭제</h3>
