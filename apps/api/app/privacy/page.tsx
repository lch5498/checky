...
const privacySections = [
  {
    title: '수집하는 개인정보',
    description:
      '체키는 카카오 로그인을 통한 사용자 식별 정보, 앱에서 사용자가 직접 입력한 닉네임, 모임 및 구성원 정보, 일정, 기념일, 차량 및 주차 위치, 학교·학원 정보와 전화번호를 서비스 제공에 필요한 범위에서 저장합니다.',
  },
  {
    title: '개인정보 이용 목적',
    description:
  ...
  },
  {
    title: '제3자 제공',
    description:
      '체키는 법령에 따른 요청이 있거나 사용자가 명시적으로 동의한 경우를 제외하고 개인정보를 제3자에게 판매하거나 제공하지 않습니다. 사용자 인증에는 카카오 로그인을 사용합니다.',
  },
  {
    title: '보관 및 삭제',
    description:
      '개인정보는 서비스 이용 기간 동안 보관됩니다. 사용자는 앱의 프로필 화면에서 탈퇴를 요청할 수 있으며, 탈퇴 시 계정과 관련 데이터는 삭제되고 복구되지 않습니다.',
  },
  {
    title: '보안',
    description:
